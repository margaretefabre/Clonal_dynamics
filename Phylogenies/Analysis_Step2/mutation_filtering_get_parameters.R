#----------------------------------------------------------------------------------------
# mutation_filtering_get_parameters.R
#----------------------------------------------------------------------------------------
...
R_function_files = list.files("/nfs/casm/team163gv/mf13/COLONIES/my_functions/my_functions/",pattern=".R",full.names=TRUE)  #This should point to where ever this script is saved
...
#on farm5:
#	chmod +x /lustre/scratch119/casm/team163gv/mf13/COLONIES/Mutation_filtering_get_parameters.R
#	bsub -o $PWD/log.%J -e $PWD/err.%J -q normal -R 'select[mem>=16000] span[hosts=1] rusage[mem=16000]' -M16000 -n6 -J filter1_PD34493 /lustre/scratch119/casm/team163gv/mf13/COLONIES/Mutation_filtering_get_parameters.R -r PD34493 -s /nfs/casm/team163gv/mf13/COLONIES/PD34493/subs/PD34493_1_filtered_merged_cut.tsv -i /nfs/casm/team163gv/mf13/COLONIES/PD34493/indels/PD34493_1_indel_filtered_merged_cut.tsv -o /lustre/scratch119/casm/team163gv/mf13/COLONIES/PD34493/PD34493_1/filter1_output2/
#	bsub -o $PWD/log.%J -e $PWD/err.%J -q normal -R 'select[mem>=16000] span[hosts=1] rusage[mem=16000]' -M16000 -n6 -J filter1_PD41276 /lustre/scratch119/casm/team163gv/mf13/COLONIES/Mutation_filtering_get_parameters.R -r PD41276 -s /nfs/casm/team163gv/mf13/COLONIES/PD41276/subs/PD41276_1_filtered_merged_cut.tsv -i /nfs/casm/team163gv/mf13/COLONIES/PD41276/indels/PD41276_1_indel_filtered_merged_cut.tsv -o /lustre/scratch119/casm/team163gv/mf13/COLONIES/PD41276/PD41276_1/filter1_output2/
#	bsub -o $PWD/log.%J -e $PWD/err.%J -q normal -R 'select[mem>=16000] span[hosts=1] rusage[mem=16000]' -M16000 -n6 -J filter1_PD41305 /lustre/scratch119/casm/team163gv/mf13/COLONIES/Mutation_filtering_get_parameters.R -r PD41305 -s /nfs/casm/team163gv/mf13/COLONIES/PD41305/subs/PD41305_1_filtered_merged_cut.tsv -i /nfs/casm/team163gv/mf13/COLONIES/PD41305/indels/PD41305_1_indel_filtered_merged_cut.tsv -o /lustre/scratch119/casm/team163gv/mf13/COLONIES/PD41305/PD41305_1/filter1_output2/


#--------------------------------------------------------------------------------------------------------------------------------------------

# Next steps are in Analysis_Step3
