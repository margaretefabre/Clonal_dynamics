# Title: "Sensitivity_analysis_from_SNPs.R"
...
setwd("/lustre/scratch119/casm/team163gv/mf13/COLONIES/")
library(data.table)

##Define the REFERENCE GERMLINE MUTATIONS set for each foetus

#Get reference set of SNPs/ INDELs for PD34493.  Get from the post-LCM-artefact-filtering mutation sets (i.e. SNPs still retained).
mats_and_params_file_PD34493 = "/lustre/scratch119/casm/team163gv/mf13/COLONIES/PD34493/PD34493_1/filter1_output2/mats_and_params_PD34493" #Path to full output file of the "Mutation_filtering_get_parameters.R" script
load(mats_and_params_file_PD34493)
germline_SNVs_PD34493 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "SNV" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05 & rowSums(COMB_mats$NR) > 500]
germline_INDELs_PD34493 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "INDEL" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05  & rowSums(COMB_mats$NR) > 500]

#Get reference set of SNPs/ INDELs for PD41276.  Get from the post-LCM-artefact-filtering mutation sets (i.e. SNPs still retained).
mats_and_params_file_PD41276 = "/lustre/scratch119/casm/team163gv/mf13/COLONIES/PD41276/PD41276_1/filter1_output2/mats_and_params_PD41276" #Path to full output file of the "Mutation_filtering_get_parameters.R" script
load(mats_and_params_file_PD41276)
germline_SNVs_PD41276 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "SNV" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05  & rowSums(COMB_mats$NR) > 500]
germline_INDELs_PD41276 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "INDEL" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05  & rowSums(COMB_mats$NR) > 500]

#Get reference set of SNPs/ INDELs for PD41305.  Get from the post-LCM-artefact-filtering mutation sets (i.e. SNPs still retained).
mats_and_params_file_PD41305 = "/lustre/scratch119/casm/team163gv/mf13/COLONIES/PD41305/PD41305_1/filter1_output2/mats_and_params_PD41305" #Path to full output file of the "Mutation_filtering_get_parameters.R" script
load(mats_and_params_file_PD41305)
germline_SNVs_PD41305 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "SNV" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05  & rowSums(COMB_mats$NR) > 500]
germline_INDELs_PD41305 = COMB_mats$mat$mut_ref[COMB_mats$mat$Mut_type == "INDEL" & log10(filter_params$germline_pval) > -6 & filter_params$bb_rhoval < 0.05  & rowSums(COMB_mats$NR) > 500]
...
sensitivity_analysis_PD34493 = create_sensitivity_df(germline_SNV_set=germline_SNVs_PD34493,
                                                 SNV_calls_folder="PD34493/PD34493_1/subs/",
                                                 SNV_calls_file_ext="_complete_final_retained_3.vcf",
                                                 germline_INDEL_set=germline_INDELs_PD34493,
                                                 INDEL_calls_folder = "PD34493/PD34493_1/indels/")

sensitivity_analysis_PD41276 = create_sensitivity_df(germline_SNV_set=germline_SNVs_PD41276,
                                                SNV_calls_folder="PD41276/PD41276_1/subs/",
                                                SNV_calls_file_ext = "_complete_final_retained_3.vcf",
                                                germline_INDEL_set=germline_INDELs_PD41276,
                                                INDEL_calls_folder = "PD41276/PD41276_1/indels/")
                                                
sensitivity_analysis_PD41305 = create_sensitivity_df(germline_SNV_set=germline_SNVs_PD41305,
                                                SNV_calls_folder="PD41305/PD41305_1/subs/",
                                                SNV_calls_file_ext = "_complete_final_retained_3.vcf",
                                                germline_INDEL_set=germline_INDELs_PD41305,
                                                INDEL_calls_folder = "PD41305/PD41305_1/indels/")

##SAVE THE DATAFRAMES
write.table(sensitivity_analysis_PD34493, file = "PD34493/PD34493_1/sensitivity_analysis_PD34493", row.names = FALSE)
write.table(sensitivity_analysis_PD41276, file = "PD41276/PD41276_1/sensitivity_analysis_PD41276", row.names = FALSE)
write.table(sensitivity_analysis_PD41305, file = "PD41305/PD41305_1/sensitivity_analysis_PD41305", row.names = FALSE)